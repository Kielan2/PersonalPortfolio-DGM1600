...
newButton.addEventListener('click', () => {
    ...
    let pokeType = prompt('What is your Pokemon type?')
    let newPokemon =  new Pokemon(pokeName, pokeHeight, pokeWeight, getAbilitiesArray(pokeAbilities), pokeType)
